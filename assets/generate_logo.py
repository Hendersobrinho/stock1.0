"""
Gera a logo do programa em PNG e o Ã­cone ICO multi-tamanho a partir de um desenho simples.
...
def main() -> None:
    try:
        ...
        raise SystemExit("Pillow nÃ£o instalado. Instale com: pip install Pillow")
    ...
    print("Ãcone gerado em data/icon.ico (16..256)")
